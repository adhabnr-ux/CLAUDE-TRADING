...
| JNJ    | Healthcare | 2026-05-22 | **PROMOTED 2026-07-16 — full diligence pass (first since 2026-05-22 add).** Q2 2026 beat+raise reported July 15: sales USD 25.3B (+6.6%), adj EPS USD 2.90 vs USD 2.85 consensus; FY26 guidance raised (adj EPS midpoint USD 11.68, sales USD 101.1B/+7.3%, first-ever USD 100B revenue year in sight). Analyst upgrades post-print: TD Cowen USD 250→300, RBC USD 265→287. Technical confirmation clean (+3.97% above 50-day MA of USD 237.59, ATR 2.293% — no size-halving needed). Valuation stretched (forward P/E 21.17x vs sector 18.49x and JNJ's own 5-yr avg 15.65x) — fails the valuation gate, but 4/5 entry signals clear (earnings momentum, catalyst, technical, macro). Buy plan written for 2026-07-16 market-open. | Review by 2026-08-15 (renewed at promotion) |
...
| TER    | Industrials / AI Test | 2026-07-16 | Research-only, added from Thursday fresh-candidate scan. Teradyne — chip-test equipment, a picks-and-shovels AI-infrastructure play (semiconductor test capacity scaling with AI accelerator production). Not yet diligenced — needs full pass (fundamentals, valuation, technical, ATR) before promotion. | Diligence not yet started |
...
## Active Macro Watches (updated 2026-07-16 pre-market)

- **July 16 pre-market:** S&P 500 futures modestly higher (~+0.2%, one source flagged −0.1% — mixed) on a cooler-than-expected June CPI (headline −0.4% MoM, YoY eased to 3.5%; core held 2.6%). 10yr yield ~4.57% (below the 4.75% halt trigger). Constructive-but-mixed tape, no halt triggers close. CAT sharply weaker on dealer-inventory/margin-compression/cooling-industrial-cycle commentary (see position note below) — an idiosyncratic/sector story, not a broad risk-off signal. JNJ diligenced today and promoted to a buy candidate (Q2 beat+raise reported yesterday) — see Watchlist row above and research-log.md.
