...
_Watchlist hygiene (updated 2026-07-09 pre-market): entries require date added + catalyst with expiry. Stale entries (4+ weeks, catalyst expired) purged. **LRCX ATR gate cleared 1/2 on July 8 (4.116%) and is now trading +2.39% ABOVE its ~50-day MA ($325.40)** — improving on both fronts after the July 7 reset (5.31% fail); needs one more clean ATR session. Hit the 4-week staleness line July 8 — purge/keep decision deferred to Friday 2026-07-10 weekly review per existing plan (note the recent improvement before deciding). **ETN ATR gate cleared 3 consecutive sessions (July 6-8) but still fails technical confirmation — July 8 close is −1.537% below its ~50-day MA ($405.95), narrowing from −2.31% July 7.** CEG diligenced 2026-07-07 — still fails technical confirmation, not re-checked since. VRT received its full pre-trade diligence pass 2026-07-08 — fundamentals/valuation pass (PEG 1.36) but fails both technical confirmation (~6% below 50-day MA) and the ATR gate (6.15% July 7) — not promoted, not re-checked since. **NVT received its full pre-trade diligence pass 2026-07-09** — fundamentals/valuation/catalyst pass (PEG 1.18, FY26 adj. EPS guide raised to $4.45-4.55, backlog $2.6B) and the ATR gate clears (3.015%), but fails technical confirmation (−5.82% below its ~50-day MA of $164.44) — not promoted. MOD ATR-only checked 2026-07-09 (6.198%, fails) — still needs a full diligence pass. **ABBV and CAT added 2026-07-09** (Thursday fresh-candidate scan) — both research-only, undiligenced.
...
| ABBV   | Healthcare | 2026-07-09 | NEW — AbbVie; 52-week high July 2 on 340B drug-pricing reform tailwind (shifts margin to drug developers from hospitals); USD 10.9B Apogee Therapeutics acquisition expands immunology pipeline | Research-only — needs full pre-trade diligence pass before any entry consideration |
| CAT    | Industrials | 2026-07-09 | NEW — Caterpillar; Q1 beat/raise (rev USD 17.42B, adj. EPS USD 5.54), FY26 sales outlook raised, dividend hiked 8%, Zacks Rank #1; headwind: USD 2.2-2.4B 2026 tariff costs compressing Resource Industries margins ~500bp | Research-only — needs full pre-trade diligence pass before any entry consideration; next earnings Aug 4, 2026 |
...
## Active Macro Watches (updated 2026-07-09 pre-market)

- **Iran conflict escalates further — fresh US airstrikes (July 9, NEW):** The US launched new strikes overnight (80+ targets: air defense, command/control, radar, anti-ship missile capability, small boats); Tehran retaliated against Gulf countries. Some shipping insurers are advising a pause on Strait of Hormuz voyages. Oil choppy but still well below the $100 halt-trigger (Brent ~$77-79, WTI ~$72-74). 10yr yield 4.587-4.59% (4-week high) — still below the 4.75% halt trigger but trending the wrong way. Monitor closely — if WTI closes above $100 or the 10yr closes above 4.75%, halt all new buys.
...
- **LLY — position:** July 9 pre-market $1,208.00 (+10.468% from entry). HWM $1,249.45 / stop $1,124.505, buffer 6.913%. FY26 revenue guidance raised to $82-85B; JPMorgan top-pick ($1,400 PT), RBC raised to $1,500. Healthcare flagged today as the top 52-week-high sector. review_by 2026-07-21 not due. HOLD. Conviction A.
- **V — position:** July 9 pre-market $346.662 (+7.137% from entry). HWM $364.21 / stop $327.789, buffer 5.443%. Barclays Overweight, Wells Fargo Buy, Baird PT $412 stand. No Iran/oil exposure identified; thesis intact. review_by 2026-07-28. Conviction B.
- **VST — re-entry review:** Not re-checked today (no held position, no near-term catalyst change).
- **NVDA — off watchlist, cooling period expired July 9 (today)** — not proactively re-added; would need a fresh diligence pass to re-enter consideration.
- **LRCX — ATR gate cleared 1/2 on July 8 (4.116%)** and now trading +2.39% ABOVE its ~50-day MA ($325.40) — improving on both fronts. Needs one more clean session. Hit the 4-week staleness line — purge/keep decision deferred to Friday 2026-07-10 weekly review.
- **ETN — ATR gate cleared 3 consecutive sessions (July 6-8) but technical confirmation still fails** — July 8 close −1.537% below ~50-day MA ($405.95), narrowing from −2.31% July 7.
- **CEG diligence completed 2026-07-07:** still fails technical confirmation (11.55% below 50-day MA) — not re-checked since.
- **VRT diligence completed 2026-07-08:** fundamentals/valuation pass (PEG 1.36) but fails technical confirmation (~6.1% below 50-day MA) AND the ATR gate (6.15% July 7) — not promoted, not re-checked since.
- **NVT diligence completed 2026-07-09:** fundamentals/valuation/catalyst pass (PEG 1.18, FY26 adj. EPS guide raised) and ATR gate clears (3.015%) but fails technical confirmation (−5.82% below ~50-day MA of $164.44) — not promoted.
- **MOD:** ATR-only checked 2026-07-09 (6.198%, fails gate) — still needs a full diligence pass.
- **ABBV, CAT added 2026-07-09** (Thursday fresh-candidate scan) — both research-only, undiligenced.
