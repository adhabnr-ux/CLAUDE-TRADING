...
## Active Macro Watches (updated 2026-07-10 pre-market)
...
- **ETN — ATR gate cleared again July 9 (2.135%); technical confirmation flipped to barely PASSING** (+0.047% above ~50-day MA — noise-level) — not promoted, needs real separation above the MA.
